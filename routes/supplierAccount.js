    ...
    async.auto({
        ordersPart:async function (cb) {
            try{
             ...
             sql1="select (SELECT request_status from agent_supplier_payouts where order_id=o.id limit 1) as withdraw_request_status,o.net_amount as total_order_price,o.self_pickup,o.supplier_vat_value,o.user_service_charge, s.id,aro.status,aro.commission,aro.order_id,IFNULL(odp.discountAmount,0) as discountAmount,s.name,u.firstname,o.delivered_on,o.handling_admin,o.handling_supplier,o.delivery_charges,o.urgent_price,o.net_amount-discountAmount as net_amount,aro.total_amount from account_payable ar join account_payable_order aro " +
