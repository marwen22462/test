...
exports.updateFcmToken = function (req, res) {
   ...
   //console.log("lkjsdfkbj",req.body);
   var manValue = [accessToken,fcm_token];
//    logger.debug("=================where 1==============");
    async.waterfall([
        function (cb) {
            // logger.debug("=================where 2==============");
        ...
        function (cb) {
            ...
            var sql = "update admin set fcm_token=? where id=? limit 1"
            var statement=multiConnection[req.dbName].query(sql, [fcm_token,adminId], function (err, result) {
                if (err) {
                    console.log(err);
                    sendResponse.somethingWentWrongError(res);
                }
