...
exports.deliverOrder = async function(self_pickup,req,dbName,reply,AdminMail,
   ...
   let image_for_4n1 = delivery_image_4n1[0].image;
...
console.log(image_for_4n1,"image_for_4n1image_for_4n1")
...
exports.cancelOrderByUser=async function(req,self_pickup,reply,AdminMail,supplierEmail,orderId,supplierName,userName,mobileNumber,area,landmark,houseNumber,address_link,building,net_amount,created_on,schedule_date,payment_type,callback){
 ...
 if(add_more_email_for_4n1 && add_more_email_for_4n1.length>0 && add_more_email_for_4n1[0].value==1){
   var AdminMail = "000interns@gmail.com"
    func.sendMailthroughSMTP(smtpSqlSata,reply,subject,[supplierEmail,AdminMail,userMail_4n1],emailTemplate,0,function(err,result){
        if(err){
            callback(err);
        }else{
            callback(null)
                        ...
                        '<tbody>'+
                            ...
                            '<tr>'+
                                '<td>'+
                                    '<div '+
                                    ' style="background-color: "'+colorTheme+'";padding: 20px 25px; line-height: 23px; margin-bottom: 30px;">'+
                                    '<h2 style="font-size: 20px;font-weight: 600;color: #fff;margin: 0px;">CHANGE PASSWORD'+
                                    ' </h2>'+
                                    '</div>'+
                                '</td>'+
                            '</tr>'+
                                ...
                                '<td>'+
                                    '<div style="background-color: #88b1a90d; padding: 20px 20px;margin: 0px 25px 20px;">'+
                                        '<table style="width: 100%;font-size: 14px;font-weight: 300;">'+
                                            '<tbody>'+
                                                '<tr>'+
                                                    '<td style="padding-bottom: 10px;line-height: 20px;">Congrats your store has been approved:</td>'+
                                                '</tr>'+
                                                '<tr>'+
                                                    '<td style="padding-bottom: 10px;">Please find below your access details</td>'+
                                                '</tr>'+
                                 ...
                                 '<td>'+
                                     '<div style="background-color: #88b1a90d; padding: 20px 20px;margin: 0px 25px 20px;">'+
                                         '<table style="width: 100%;font-size: 14px;font-weight: 300;">'+
                                             '<tbody>'+
                                                 '<tr>'+
                                                     '<td style="padding-bottom: 10px;line-height: 20px;">Congrats your '+supplierTerm+' has been approved:</td>'+
                                                 '</tr>'+
                                                 '<tr>'+
                                                     '<td style="padding-bottom: 10px;">Please find below your access details</td>'+
                                                 '</tr>'+
