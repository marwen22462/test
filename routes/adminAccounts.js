                    ...
                    (async function (i) {
                        ...
                        if(1){
                            ...
                            if(reslt[0] != undefined 
                                ...
                                && reslt[0].card_payment_id != "" 
                                && reslt[0].is_agent_stripe_split_enabled=="1"){
...
exports.getAdminChatList = function (req,res) {
    ...
    async.auto({
        ...
        getChat:['authenticate', async function(cb){
            ...
            var agent_db = "gromarkt_agent_db"
