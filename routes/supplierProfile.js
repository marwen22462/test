...
exports.saveSeeupplierProfileSubTab1 = async function (req,res) {
    ...
    // is_vat_applicable allow_agent_section_in_supplier allow_geofence_section_in_supplier
                ...
                var sql = "update supplier  set delivery_charge_tax=?,is_scheduled=?,country_of_origin=?,is_dine_in=?,distance_value=?,description=?,brand=?,linkedin_link=?,facebook_link=?,nationality=?,speciality=?,user_request_flag=?,license_number=?,user_service_charge=?, address=?,is_sponser=?, country_code=?, iso=?, radius_price=?,self_pickup=?,phone = ?,mobile_number_1 = ?,mobile_number_2 = ?, "
                sql += " default_commission=?,supplier_tap_token=?, vat_value=?, slogan_ol=?,slogan_en=?, trade_license_no = ? ,business_start_date = ?,is_recommended = ?, email = ?, "
                sql += " name = ?,latitude = ?,longitude = ?,delivery_radius = ?,is_area_restricted = ?,delivery_type = ?,commission = ?,pickup_commission=?,base_delivery_charges=?,currency_exchange_rate=?,local_currency=?,is_own_delivery=?,is_out_network=?,is_user_service_charge_flat=?,table_booking_price=?,is_free_delivery=?,table_booking_discount=?,is_vat_applicable=?,  allow_agent_section_in_supplier=?, allow_geofence_section_in_supplier = ? where id = ? limit 1";
               
                await Execute.Query(req.dbName,sql,[delivery_charge_tax,is_scheduled,country_of_origin,is_dine_in,
               ...
               let totalLengthSuppProduct=totalSupplierProduct && totalSupplierProduct.length>0?(totalSupplierProduct.length-1):0
                ...
                var sql = "update supplier set delivery_charge_tax=?,is_scheduled=?,default_commission=?,description=?,brand=?,linkedin_link=?,facebook_link=?,nationality=?,speciality=?,user_request_flag=?,license_number=?,user_service_charge=?, address=?,is_live=?,self_pickup=?,phone = ?,mobile_number_1 = ?,mobile_number_2 = ?, "
               ...
               await Execute.Query(req.dbName,sql,[delivery_charge_tax,is_scheduled,default_commission,description,brand,linkedin_link,
