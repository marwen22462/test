                      ...
                      detailedSubCategoryId, names[0], priceUnit,
                       descriptions[0], sku, barCode, commission,
                        commissionType, commissionPackage,
                         ...
                         item_unavailable,is_non_veg,is_appointment,calories,cb);
            },
            async function (id, cb) {
                productId = id;
...
async function insertProductBySupplierBranch(dbName,res, branchId,
     categoryId, subCategoryId, detailedSubCategoryId, name, priceUnit,
      description, sku, barCode, commission, commissionType,
       ...
       is_driver,cart_image_upload,
       payment_after_confirmation,
       item_unavailable,is_non_veg,is_appointment,calories,callback) {
try{
    ...
    var params=[cart_image_upload,payment_after_confirmation,pricing_type,1,name, priceUnit, barCode, description, sku, detailedSubCategoryId, 0, branchId, 2, commission, commissionType, commissionPackage, measuringUnit,quantity,parent_id,brand_id,is_product,duration,is_non_veg,calories];
