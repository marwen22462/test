...
module.exports.getServicesListingByBranchId = (dbName,branchId,
    ...
    return new Promise(async(resolve,reject)=>{
        try{
            ...
            join product_pricing price on p.id = price.product_id 
            ...
            ${branchCheck}
            and DATE(price.start_date) <=  CURDATE()
            and DATE(price.end_date) >= CURDATE() ) or (price.price_type = 0))
            and ((price.pricing_type=1) or(price.pricing_type=0))
