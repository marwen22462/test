...
app.post('/update_fcm_token',Auth.checkCblAuthority, Auth.storeDbInRequest,admin.updateFcmToken);
app.post('/supplier/update_fcm_token',Auth.checkCblAuthority, Auth.supplierAuth,supplierSetup.updateFcmToken);
